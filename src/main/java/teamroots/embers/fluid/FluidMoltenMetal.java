...
public class FluidMoltenMetal extends Fluid {
    ...
    public FluidMoltenMetal(String fluidName, String resourceName) {
        super(fluidName, new ResourceLocation(Embers.MODID, "blocks/molten_" + resourceName + "_still"), new ResourceLocation(Embers.MODID, "blocks/molten_" + fluidName + "_flowing"));
